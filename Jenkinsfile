pipeline {
    ...
    stages {
        ...
        stage('Checkout SCM') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: 'master']], extensions: [], userRemoteConfigs: [[credentialsId: 'payex', url: 'https://github.com/gpx-prince-frimpong/rsvpapp-helm-cicd.git']]])
            }
        }
        stage('Build Packges') {
            parallel {
